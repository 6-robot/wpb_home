...
![10 pic](http://63.223.108.84/wpb_ros/WP-B1-ROS/BH_11.png)

### 11. 传感器融合
启智ROS版可以将立体相机三维点云和激光雷达SLAM二维地图进行融合，更好整合环境信息。
![11 pic](http://63.223.108.84/wpb_ros/WP-B1-ROS/BH_20.png)

### 12. 语音识别
启智ROS版使用卡耐基梅隆大学开发的PocketSphinx语音识别引擎，可以对语音指令进行识别。
![12 pic](http://63.223.108.84/wpb_ros/WP-B1-ROS/BH_10.png)
